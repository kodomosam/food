...
<head>
  ...
  <title>Pizzaria Don Rafaello <?php echo $this->renderSection('titulo') ?></title>
  <!-- plugins:css -->
  ...
  <!--essa section renderizara os estilos especificos da view que estender este layout -->
...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <!--Renderiza so conteudos especificos da view que estender esse layout --> 
  ...
  <!--Renderiza so scripts especificos da view que estender esse layout --> 
